          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center mb-4">            
                ...
                <img v-if="gender == 'other' || gender == undefined" src="static/img//website/profile_other.png" class="rounded-circle mb-2" alt="User Profile"  width="150" height="150">
              ...
              <div class="text-center">
                <button v-if="!isFriend" @click="follow(id)" class="btn btn-info w-30">Follow this user</button>
                <button v-if="isFriend" @click="unfollow(id)" class="btn btn-info w-30">Unfollow this user</button>
              </div>
            </div>
          </div>
        </div>
